        ...
        <nav  class="navbar navbar-expand-lg navbar-light p-3">
            <div class="container correr">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    <Link to="/" class="nav-link text-light" aria-current="page" href="index.html">Inicio</Link>
                  </li>
                  <li class="nav-item">
                    <Link to="/nosotros" class="nav-link text-light" aria-current="page" href="Nosotros.html">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nosotros</Link>
                  </li>
                  <li class="nav-item">
                    <Link to="/menu" class="nav-link text-light" href="menú.html">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Menú</Link>
                  </li>
                  <li class="nav-item">
                    <Link to="/servicios" class="nav-link text-light" href="Servicios.html">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Servicios</Link>
                  </li>
                  <li class="nav-item">
